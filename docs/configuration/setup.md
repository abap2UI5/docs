...
You can run abap2UI5 with a range of custom configurations. The default setup works automatically. To customize it, implement the `z2ui5_if_exit` interface:
