...
### Release-Specific
Certain controls and properties are only available in specific UI5 releases. The abap2UI5 framework and its samples support many UI5 versions, minimizing compatibility issues. But when building your own applications, verify compatibility with the UI5 version your system uses.
