...
Technically, abap2UI5 is simply an HTTP handler implementation — use it like any other HTTP service in production.

#### Preparations
Transport abap2UI5 to production like any other ABAP project. For a smooth rollout, consider these steps:
...
3. Test the "Hello World" app to verify abap2UI5 works correctly.
...
#### Renaming
If you're starting new development but already have abap2UI5 apps in production and want to avoid update risk, install multiple instances of abap2UI5 through the [renaming feature](/advanced/renaming). This lets you keep developing safely without affecting your existing production apps.
