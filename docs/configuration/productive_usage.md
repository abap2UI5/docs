...
#### Stable Version
The project evolves continuously, so there's no fixed "stable" version. But we keep changes to the public APIs minimal to avoid frequent app refactoring. Pin to a [release](https://github.com/abap2UI5/abap2UI5/releases/) instead of pulling the main branch, and update periodically to reduce refactoring effort.
