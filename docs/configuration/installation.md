...
### R/3 NetWeaver
The setup matches `S/4 Private Cloud`. Depending on your release level, you might also be able to add the apps to Launchpads. Follow the [Fiori Launchpad](/configuration/launchpad) guide.
