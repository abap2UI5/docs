...
### S/4 Private Cloud
In `S/4 Private Cloud`, you can make the HTTP endpoint accessible to business users and manage extra authorizations. However, to also use the SAP Fiori Launchpad, install an extra frontend app. See [Fiori Launchpad](/configuration/launchpad) for details.
