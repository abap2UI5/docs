...
### Backend Code
abap2UI5 ships as custom code. Once installed, you own the code in full and can modify it as needed. To preserve compatibility with future updates, however, avoid direct modifications to the core codebase.
