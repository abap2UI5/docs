...
- Prefer `client->_bind` and use `client->_bind_edit` only when users need to make changes that the backend processes. Otherwise, you'll incur unnecessary data transfers.
