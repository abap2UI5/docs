...
- Prefer `client->_bind`; use `client->_bind_edit` only when users need to make changes that the backend processes. Otherwise, you'll trigger unnecessary data transfers.
