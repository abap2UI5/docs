...
For a comprehensive overview, see the [Use Cases blog article](https://www.linkedin.com/pulse/use-cases-abap2ui5-overview-abap2ui5-udbde/?trackingId=6iIX%2FNk%2BCT0%2B4JorQjpRSQ%3D%3D).
...
#### Tier 1 Extension
Build applications separately from your S/4 system's lifecycle via remote API calls only. Stick to released APIs, and your apps will work with S/4HANA Public Cloud too:
