...
Clearly, building methods compatible with both 'ABAP Cloud' and 'Standard ABAP' is much more complex. Fortunately, abap2UI5 needs only GUIDs as a dependency. But when building apps, keep this in mind (and whether it's practical remains to be seen). It does have one key advantage: abap2UI5 runs on ABAP 2305 and stays portable down to NetWeaver 7.02.
