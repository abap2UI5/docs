...
This lets us define models not only at design time, but also at runtime. The user needs no extra work, since abap2UI5 handles the entire process in the background on every AJAX request:
