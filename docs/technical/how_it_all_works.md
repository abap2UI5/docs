...
But having no extra layer also means the framework doesn't necessarily abstract complexity away — unlike what other frameworks target. In abap2UI5, you send your XML-View directly to the frontend, and you're responsible for making sure it's valid and executable:
