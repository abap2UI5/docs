...
So far, we've seen that the abap2UI5 frontend app doesn't know the specific application, just like the generic HTTP-Service on the server, which also doesn't know the particular model and view it's transmitting. So, which layer ultimately defines what happens in this architecture?
