...
The first GET request sends the artifacts of the UI5 (HDA) app to the browser. We would usually deploy a BSP to the ABAP stack for this, but in abap2UI5, the code lives as a string inside the HTTP-Handler's initial-request implementation:
