...
In the current approach, we separate them from the view and create them via extra methods. The framework then handles the entire process of data binding and transfer automatically (9):
