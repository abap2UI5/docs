...
Luckily, utility classes greatly simplify the creation process. For example, `z2ui5_cl_xml_view` offers a class-based approach to create views with access to the UI5 API via ADT code completion:
