...
Luckily, utility classes greatly simplify the creation process. For instance, `z2ui5_cl_xml_view` provides a class-based approach to create views with access to the UI5 API through ADT code completion:
