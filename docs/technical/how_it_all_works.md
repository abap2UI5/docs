...
To recap what we've covered so far: abap2UI5 is built in a highly generic way, placing most of the responsibility on the user's apps. As a result, we gain a lot of flexibility and freedom in the app implementation, but we also take on full responsibility for view creation and program flow. We also have to keep these downsides in mind.
