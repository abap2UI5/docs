...
In addition to the abap2UI5 core framework, all abap2UI5 apps are stored as ABAP classes — abapGit-managed objects — so you can install them via abapGit without any manual deployment, unlike traditional UI5 apps.
