...
abap2UI5 is fully cloud-ready. It supports modern, backend-driven UI5 development while remaining upgrade-stable and compatible with SAP BTP ABAP Environment and S/4HANA Public Cloud. Each app can be built cloud-ready, making abap2UI5 a strong addition to existing RAP or UI5 freestyle apps.
