...
Let's look closely at a key UI5 feature: the concept of view models. In UI5 freestyle, view models bind attributes such as visible or enabled — mapping control properties in the view precisely to model attributes:
