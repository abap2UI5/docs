...
Since UI5 is a client-side framework, the backend can't generate ready-to-render HTML. Instead, the browser creates the HTML with JavaScript via the UI5 framework.
