...
In abap2UI5, apps are simply ABAP classes — deployment is as simple as activating the class. Transport to production runs via the standard transport system from traditional ABAP development:
