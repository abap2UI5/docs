...
ENDCLASS.
```
What abap2UI5 adds: the ability to run in the browser without ADT, through a UI5 frontend that fully follows SAP Fiori design guidelines — ready to share with your colleagues.
