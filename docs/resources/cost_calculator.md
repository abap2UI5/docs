...
<div class="cost-line"><span class="cost-what">Support<small><span data-echo="cost-support">Community support</span>: <a href="https://github.com/abap2UI5/abap2UI5/issues" target="_blank" rel="noopener">GitHub issues</a> and <a href="https://abapgit.slack.com/join/shared_invite/zt-46tqufaht-QlrxTzlDqlx85CWbeUnOqg#/shared-invite/email" target="_blank" rel="noopener">Slack</a> are open to everybody either way</small></span><span class="cost-amount" data-amount>€0</span></div>
