...
- Webinar on creating UI5 interfaces from ABAP using abap2UI5 [(YouTube - 12.12.2024)](https://www.youtube.com/watch?v=N2OAdxf7Lng)
...
- Cust&Code Videos featuring abap2UI5 [(YouTube - 20.05.2024)](https://www.youtube.com/watch?v=SD1vIt_ty0k)
...
- See abap2UI5 on ABAP Open Source Projects [(dotabap.org)](https://dotabap.org/)

## Blogs

_Blog posts may contain outdated information. Always check these docs for the latest details._
...
3. Popups, Value-Help, Messages & Controller Logic [(SCN - 30.03.2023)](https://blogs.sap.com/2023/03/30/abap2ui5-3-4-flow-logic-pop-ups-f4-help/)
...
8. Repository Organization: Working with abapGit, abaplint, and open-abap [(SCN - 21.08.2023)](https://blogs.sap.com/2023/08/21/abap2ui5-a1-repository-setup-with-abapgit-abaplint-open-abap/)
