...
Versions, dates, and highlights for every published release. The latest release is at the top.

Releases follow the UI5 minor-version convention: patch and minor numbers move forward together (1.113.0, 1.114.0, …). The number reflects the UI5 minor version the release was built against and is also surfaced in the navigation header.
