...
Deliberately ONE parameter. The moment a second is needed - tab / tab_index for a row path, omit_initial, json, switch_default_model - _bind( ) is the right call and path stays on it.
