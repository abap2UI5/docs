...
| `cs_event-hash_set` | `SET_PUSH_STATE` | *experimental* |
| `cs_event-hash_replace` | `HASH_REPLACE` | *experimental* |
| `cs_event-hash_back` | `HASH_BACK` | *experimental* |
| `cs_event-hash_attach_changed` | `HASH_ATTACH_CHANGED` | *experimental* |
| `cs_event-hash_routing` | `SET_NAV_ROUTING` | *experimental* |
| `cs_event-app_state_set_active` | `SET_APP_STATE_ACTIVE` | *experimental* |
| `cs_event-clipboard_app_state` | `CLIPBOARD_APP_STATE` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-image_editor_popup_close` | `IMAGE_EDITOR_POPUP_CLOSE` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-nav_container_to` | `NAV_CONTAINER_TO` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-nest_nav_container_to` | `NEST_NAV_CONTAINER_TO` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-nest2_nav_container_to` | `NEST2_NAV_CONTAINER_TO` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-popup_nav_container_to` | `POPUP_NAV_CONTAINER_TO` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-popover_nav_container_to` | `POPOVER_NAV_CONTAINER_TO` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-z2ui5` | `Z2UI5` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
| `cs_event-wizard_set_next_step` | `WIZARD_SET_NEXT_STEP` | *superseded by app_state_get_href( ) + cs_event-clipboard_copy: the* |
