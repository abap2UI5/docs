...
| Sample | Class |
|---|---|
| Basics VII — Translatable Texts (Text Elements) | [`Z2UI5_CL_SMP_APP_519`](https://github.com/abap2UI5/samples/blob/main/src/z2ui5_cl_smp_app_519.clas.abap) |
