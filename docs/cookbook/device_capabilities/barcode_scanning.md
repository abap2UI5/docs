...
| Sample | Class |
|---|---|
| sap.ndc - BarcodeScannerButton — sap.ndc.BarcodeScannerButton expressed in abap2UI5 - a SAPUI5-only control, so the demo kit original is outside OpenUI5 and this is orientation rather than a 1:1 port. | [`Z2UI5_CL_SMPC_SAPUI5_011`](https://github.com/abap2UI5/samples-controls/blob/main/src/03/z2ui5_cl_smpc_sapui5_011.clas.abap) · [samples-controls](https://github.com/abap2UI5/samples-controls) |
