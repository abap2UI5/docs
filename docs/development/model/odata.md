...
```
#### Bind Data
Next, bind this OData model to your view definition. Since we use a non-default model, specify the model name explicitly for each binding. Here's an example:
```abap
