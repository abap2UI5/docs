...
#### Two-Way Binding
When users need to edit data, enable two-way binding to update it in the ABAP backend. Use the `client->_bind_edit` method so that, after an event, the framework syncs the data with your ABAP class:
