...
Expression Binding lets you compute values directly in XML views through JavaScript-like expressions. This is especially useful in abap2UI5, since it cuts server roundtrips by moving calculations, logical conditions, and string operations to the frontend.
...
For all options, see the sample class `Z2UI5_CL_DEMO_APP_027` or the [UI5 documentation on expression binding](https://sapui5.hana.ondemand.com/sdk/#/topic/daf6852a04b44d118963968a1239d2c0).
