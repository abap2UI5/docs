...
For more information, see the [UI5 documentation on event handler arguments](https://openui5.hana.ondemand.com/#/topic/b0fb4de7364f4bcbb053a99aa645affe), and refer to sample `Z2UI5_CL_DEMO_APP_167`.
...
### Follow-up Action
Sometimes, you might want to call a backend function and then immediately perform an action on the frontend. This is possible with the follow-up action event:
```abap
METHOD z2ui5_if_app~main.
...
ENDMETHOD.
```
Refer to sample `Z2UI5_CL_DEMO_APP_180` for a working example.
