...
#### BAL Popup
Compared to message classes, BAL logs carry more detail — like timestamps. Use the dedicated BAL log popup to show them. All examples above work with the `Z2UI5_CL_POP_BAL` popup for richer output. An example with abap-logger:
