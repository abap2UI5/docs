...
#### Focus Handling
Most scanner devices emulate a keyboard. In such cases, you can create an input field and set focus correctly. The scanned data populates the input field as if typed on a keyboard.
