...
This section covers everything needed to get started.
...
Audio feedback is useful in some contexts. The example below plays a sound when a user fails to scan a value. The sound is a `.wav` file in the SAP MIME repository at `/SAP/PUBLIC/BC/ABAP/mime_demo/bam.wav`:
