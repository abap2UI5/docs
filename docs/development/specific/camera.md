...
abap2UI5 offers a custom control for capturing photos directly from the device camera. The control returns the image as a base64-encoded string that you can process on the backend.
