...
abap2UI5 offers a custom control `z2ui5.Timer` that fires events after a set delay. This is useful for dashboards, status monitors, or any case that needs periodic data updates without user interaction.
