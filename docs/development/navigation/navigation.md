...
#### Launchpad
We recommend using backend communication exclusively for view changes or popup calls. If you're using a Launchpad, consider navigating through the Launchpad to use browser navigation and history. Here's an example:
```abap
