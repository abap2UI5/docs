...
Showing messages and errors is a common task for ABAP developers. The functions below cover the most common cases.
...
When the user needs to acknowledge the message, display a message box they have to close:
...
What happens if your code raises uncatchable exceptions? The default HTTP handler exception output appears. Processing stops, and the user has to reload the browser. Reserve this for unexpected behavior:
