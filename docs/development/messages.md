...
Displaying messages and errors is an everyday task for ABAP developers. The functions below cover the most common cases.
...
When the user must acknowledge the message, display a message box they must close:
...
What happens if your code raises uncatchable exceptions? The default HTTP handler exception output appears. Processing stops, and the user must refresh the browser. Reserve this for unexpected behavior:
