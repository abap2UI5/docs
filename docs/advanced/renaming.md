...
The entire abap2UI5 project is developed under the `z2ui5` namespace. In certain scenarios, you may need to rename the namespace to fit customer-specific requirements, such as:
