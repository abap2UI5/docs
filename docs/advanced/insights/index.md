...
| [#3 Whatever Your ABAP Can Call](/advanced/insights/03-whatever-your-abap-can-call) | every API the system has, from BAPI to EML, behind one unchanged UI class |
