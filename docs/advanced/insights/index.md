...
| [#3 One Class, No Programming Model](/advanced/insights/03-one-class-no-programming-model) | every API the system has, from BAPI to EML, behind one unchanged UI class |
