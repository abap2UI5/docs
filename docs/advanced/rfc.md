...
The [abap2UI5 RFC Connector](https://github.com/abap2UI5-addons/rfc-connector) calls abap2UI5 apps remotely over RFC between two ABAP systems. This is useful in distributed system landscapes or with legacy systems that can't directly host UI5 frontend logic.
