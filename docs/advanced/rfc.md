...
The [abap2UI5 RFC Connector](https://github.com/abap2UI5-addons/rfc-connector) triggers abap2UI5 apps remotely via RFC between two ABAP systems. This helps in distributed system landscapes or with legacy systems that can't directly host UI5 frontend logic.
