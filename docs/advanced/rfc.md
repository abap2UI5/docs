...
The [abap2UI5 RFC Connector](https://github.com/abap2UI5-addons/rfc-connector) triggers abap2UI5 apps remotely over RFC between two ABAP systems. This is useful in distributed system landscapes or with legacy systems that can't directly host UI5 frontend logic.
...
The system that calls the app (the frontend system) ships with the UI5 library and bootstraps the UI. The system that runs the app (the backend system) doesn't have to host the UI5 runtime.
...
Steps:
1. Install the [abap2UI5 RFC Connector](https://github.com/abap2UI5-addons/rfc-connector) through abapGit on both systems
