...
### Installation
_Basically just install the project with abapGit and create & call a new HTTP Service. Use the donwport repository for lower releases and offline installation if your abap system has no access to the internet. More details here:_
