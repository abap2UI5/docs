"! <p class="shorttext">A UI5 table built entirely from RTTI</p>
"!
"! Companion snippet for the article "Somewhere on the Way to UI5, We Lost
"! RTTI". Not one field name appears in the view code: render_any( ) takes
"! TYPE STANDARD TABLE, asks RTTI for the components, and derives every
"! column and every cell binding from them.
"!
"! Change ty_s_flight and the screen changes with it, untouched.
"!
"! Shipped as abap2UI5/samples z2ui5_cl_smp_app_497.
CLASS zcl_rtti_table_view DEFINITION PUBLIC.
...
CLASS zcl_rtti_table_view IMPLEMENTATION.
