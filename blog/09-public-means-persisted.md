...
framework serializes the app instance into a generic draft table and reads it
back on the next one. What survives is exactly the `PUBLIC SECTION` — nothing
else is part of the serialized state.
